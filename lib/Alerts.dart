...
class AlertExit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        'Are you sure you want to exit the game baba ?',
        style: TextStyle(color: Styles.foregroundColor),
      ),
      actions: [
        TextButton(
...
class AlertAbout extends StatelessWidget {
  static const String authorURL = "https://www.instagram.com/samyush/";
  static const String releasesURL = "https://github.com/samyush";
